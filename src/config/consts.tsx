...
export enum Routes {
    ...
    overview = '/overview',
    onlyfans = '/statistics/onlyfans',
    creators = '/creators',
    chatter = '/tracking/chatter',
    ppv = '/tracking/ppv',
    newPassword = '/forgot/new',
    scripts = '/settings/scripts',
    autoMessages = '/settings/auto-messages',
    massMessages = '/settings/mass-messages',
...
export type IconsVariants = 'add_white' | 'of' | 'add_folder' // | 'arrow_down' | 'arrow_up' | 'arrow_left' | 'arrow_right'

export const icons = {
    'add_white': <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
    ...
    'of': <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Group">
            <path id="Vector" d="M5.47012 0.94043C2.67729 0.940415 0.410659 3.20703 0.410645 5.99986C0.41063 8.79268 2.67724 11.0593 5.47007 11.0593C8.2629 11.0593 10.5295 8.79274 10.5295 5.99991C10.5296 3.20708 8.26295 0.940444 5.47012 0.94043ZM5.47009 7.51772C4.63023 7.51771 3.95226 6.8397 3.95226 5.99987C3.95227 5.15999 4.63025 4.48204 5.4701 4.48205C6.30996 4.48205 6.98794 5.16 6.98793 5.99989C6.98793 6.83971 6.30994 7.51772 5.47009 7.51772Z" fill="white" />
            <path id="Vector_2" d="M11.157 4.73503C12.4424 5.10484 13.96 4.73504 13.96 4.73504C13.5198 6.65767 12.1234 7.86176 10.1097 8.00849C9.33564 9.80463 7.54964 11.0594 5.47021 11.0593L6.98807 6.23522C8.54834 1.27628 9.34803 0.940412 13.0484 0.94043L15.5891 0.940442C15.1641 2.81242 13.6994 4.24261 11.157 4.73503Z" fill="white" />
        </g>
    </svg>,
    ...
    'loading': <svg className='mini_loader' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
